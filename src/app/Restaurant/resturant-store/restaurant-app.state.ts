...
import { IRestaurantPromotions } from '../promotions+/restaurant-promotions-store/interfaces/restaurant-promotions.interface';
...
export type RestaurantAppState = Partial<{
  ...
  restaurantPromotions: Array<IRestaurantPromotions>;
}>;
